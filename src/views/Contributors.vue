...
<template>
  ...
  <div class="panel" style="margin-top:16px;">
    ...
    <ul class="changelog">
      ...
      <li><b>v1.3.8–v1.3.11</b> — 生活费专业版图表（收支日历 / 折线 / 圆饼三态）、数据与舆情统计页优化（数据洞察 / 贴吧舆情 / 本站舆情）、工具与分类优化（学号查询 / 教学楼速配 / 应用分类 / 教室导航）、饼图与折线展示体系重构（SVG 扇区 hover 详情、折线固定高度不变形）。</li>
      <li><b>v1.3.5–v1.3.7</b> — 生活费应用全面升级：微信/支付宝/建行账单智能导入（本地解析、清洗中转、退款冲抵、去重、按月份归入）、生活费模拟三合一、批量记账、20 个分级成就墙与隐藏彩蛋、默哀模式、生活费专业版（收支日历 / 折线 / 圆饼 / 同商户聚合 / 明细筛选 / 导出 CSV 分析）。</li>
    </ul>
